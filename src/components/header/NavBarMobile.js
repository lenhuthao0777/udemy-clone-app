        ...
        <>
            <div className="header-navbar--mobile">
                <div className={`side-bar ${SideBar ? "active" : ""}`}>
                    <div className={`side-bar__button-click ${SideBar ? "active" : ""}`} onClick={() => setSideBar(false)}>
                    ...
                    <div className="side-bar__menu">
                        ...
                        <ul className="side-bar__menu-list">
                            <li className="side-bar__menu-list--item" onClick={() => setSideBar(!SideBar)}>
                ...
                <div className={`side-bar__overlay ${SideBar ? "active" : ""}`} onClick={() => setSideBar(false)}></div>
            </div>
        </>
    );
}
