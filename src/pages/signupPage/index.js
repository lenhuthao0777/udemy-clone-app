...
function SignUp() {
    ...
    // const { isLoading } = useSelector((state) => state.SignUpFrom);
                ...
                <div className="signup-content">
                    ...
                    <form className="signup-form" onSubmit={handelForm}>
                        ...
                        <div className="signup-form__group">
                            ...
                            <div className="signup-form__group-content">
                                <AiTwotoneMail />
                                <input type="text" placeholder="E-mail" onChange={handleChangeInput} name="email" />
                                <span></span>
                            </div>
                        </div>
                        <div className="signup-form__group">
                            ...
                            <div className="signup-form__group-content">
                                <BsCardChecklist />
                                <input type="text" placeholder="Full Name" onChange={handleChangeInput} name="hoTen" />
                                <span></span>
                            </div>
                        </div>
                        <div className="signup-form__group">
                            ...
                            <div className="signup-form__group-content">
                                <AiFillPhone />
                                <input type="text" placeholder="Phone" onChange={handleChangeInput} name="soDT" />
                                <span></span>
                            </div>
                        </div>
                        {/* <div className="signup-form__group">
