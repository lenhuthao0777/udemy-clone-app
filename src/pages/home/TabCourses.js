        ...
        <div className="container">
            <div className="tabs-courses">
                <header className="tabs-courses__list">
                    <div className={`tab ${toggleState === 1 ? "active" : ""}`} onClick={() => handelTabs(1)}>
                        <span>FrontEnd</span>
                    </div>
                    <div className={`tab ${toggleState === 2 ? "active" : ""}`} onClick={() => handelTabs(2)}>
                        <span>BackEnd</span>
                    </div>
                    <div className={`tab ${toggleState === 3 ? "active" : ""}`} onClick={() => handelTabs(3)}>
                ...
                <div className="tabs-courses__content">
                    <div className={`content ${toggleState === 1 ? "active" : ""}`}>
                        <div className="headshot-banner">
                            <div className="headshot-banner__content">
                                ...
                                <p>
                                    Whether you work in machine learning or finance, web development or data science, the Python language is one of the most important skills to learn. Python's simple
                                    syntax is particularly suitable for office, web, and commercial applications.
                                </p>
                            ...
                            <div className="headshot-banner__avatar">
                                <UdeAvatar AvatarSrc={"./img/avatar3.jpg"} size="AvatarLg" />
                            </div>
                        </div>
                    ...
                    <div className={`content ${toggleState === 2 ? "active" : ""}`}>
                        <div className="headshot-banner">
                            ...
                            <div className="headshot-banner__avatar">
                                <UdeAvatar AvatarSrc={"./img/avatar1.jpg"} size="AvatarLg" />
                            </div>
                        </div>
                        <div className="carousels">
                            <Slider {...settings}>
                    ...
                    <div className={`content ${toggleState === 3 ? "active" : ""}`}>
                        <div className="headshot-banner">
                            ...
                            <div className="headshot-banner__avatar">
                                <UdeAvatar AvatarSrc={"./img/avatar2.jpg"} size="AvatarLg" />
                            </div>
                        </div>
                        <div className="carousels">
                            <Slider {...settings}>
